 ...
 * @author Admin
 */
public class Q2_BinarySearchTre {
...
//tim thang  thu 2 con co trai duyet theo breath
 ...
 public int getHeight(Node p) {
    ...
    ===================================================================
Tim node thu 5 khi duyet post
    -order.Dem so node cua seb
    -tree  = k.Gan gia tri k cho 1 thuoc tinh
...
int count = 0;
    ...
    // xóa node có giá trị lần đầu = 7 và node có 2 con khi duyệt breadth
    void breadth2(Node p, RandomAccessFile f) throws Exception {
        int count = 0;
        if (p == null) {
            return;
