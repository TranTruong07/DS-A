...
//===========================================================================
    void insert(String xBrand, int xColor, int xWeight) {
        ...
        if (xBrand.charAt(0) == 'A') {
            ...
            insert2(new Bike(xBrand, xColor, xWeight));
        }
    }
    ...
    void insert2(Bike x) {
        ...
        while (child != null) {
            if (child.info.weight == x.weight) {
                System.out.println("The key " + x + "already exists, no insertion");
                return;
            }
            father = child;
            if (x.weight < child.info.weight) {
                child = child.left;
            } else {
                child = child.right;
            }
        ...
        if (x.weight < father.info.weight) {
...
//=============================================================
    ...
    void postOrder2(Node p) {
        ...
        postOrder2(p.right);
        //logic
        if (nodef4 == null && count4 == 2 && nodef4.left != null) {
            nodef4 = p;
        }
